    ...
    <div className="movie-page">
      ...
      <div className="sticky-bar">
        ...
        <div className="form">
          ...
          <p className="selection hide-on-mobile">Voici une sélection, à vous maintenant de l’enrichir, de la personnaliser, de la modifier ou de la supprimer… " et surtout de la visionner !</p>
        </div>
      </div>
